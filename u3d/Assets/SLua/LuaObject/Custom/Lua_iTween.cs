...
public class Lua_iTween : LuaObject {
	...
	static public int RectUpdate_s(IntPtr l) {
		try {
			...
			System.Single a3;
			checkType(l,3,out a3);
			UnityEngine.Rect ret=iTween.RectUpdate(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int Vector3Update_s(IntPtr l) {
		try {
			...
			System.Single a3;
			checkType(l,3,out a3);
			UnityEngine.Vector3 ret=iTween.Vector3Update(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int Vector2Update_s(IntPtr l) {
		try {
			...
			System.Single a3;
			checkType(l,3,out a3);
			UnityEngine.Vector2 ret=iTween.Vector2Update(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int FloatUpdate_s(IntPtr l) {
		try {
			...
			System.Single a3;
			checkType(l,3,out a3);
			System.Single ret=iTween.FloatUpdate(a1,a2,a3);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
	...
	static public int PathLength_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.Transform[]))){
				...
				checkType(l,1,out a1);
				System.Single ret=iTween.PathLength(a1);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int PointOnPath_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.Transform[]),typeof(float))){
				...
				System.Single a2;
				checkType(l,2,out a2);
				UnityEngine.Vector3 ret=iTween.PointOnPath(a1,a2);
				pushValue(l,ret);
				return 1;
			}
	...
	static public int CameraFadeAdd_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a2;
				checkType(l,2,out a2);
				UnityEngine.GameObject ret=iTween.CameraFadeAdd(a1,a2);
				pushValue(l,ret);
				return 1;
			}
			else if(argc==1){
				UnityEngine.Texture2D a1;
				checkType(l,1,out a1);
				UnityEngine.GameObject ret=iTween.CameraFadeAdd(a1);
				pushValue(l,ret);
				return 1;
			}
			else if(argc==0){
				UnityEngine.GameObject ret=iTween.CameraFadeAdd();
				pushValue(l,ret);
				return 1;
			}
			LuaDLL.luaL_error(l,"No matched override function to call");
	...
	static public int Count_s(IntPtr l) {
		try {
			...
			if(argc==0){
				...
				System.String a1;
				checkType(l,1,out a1);
				System.Int32 ret=iTween.Count(a1);
				pushValue(l,ret);
				return 1;
			}
				...
				System.String a2;
				checkType(l,2,out a2);
				System.Int32 ret=iTween.Count(a1,a2);
				pushValue(l,ret);
				return 1;
			}
			LuaDLL.luaL_error(l,"No matched override function to call");
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ClearInvalidTweeens_s);
		addMember(l,Init_s);
