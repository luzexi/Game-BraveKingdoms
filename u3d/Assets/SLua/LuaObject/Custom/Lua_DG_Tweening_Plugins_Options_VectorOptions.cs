...
public class Lua_DG_Tweening_Plugins_Options_VectorOptions : LuaObject {
	...
	static public int get_axisConstraint(IntPtr l) {
		DG.Tweening.Plugins.Options.VectorOptions o = (DG.Tweening.Plugins.Options.VectorOptions)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.Options.VectorOptions));
	}
}
