...
public class Lua_DG_Tweening_Plugins_Options_RectOptions : LuaObject {
	...
	static public int get_snapping(IntPtr l) {
		DG.Tweening.Plugins.Options.RectOptions o = (DG.Tweening.Plugins.Options.RectOptions)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(DG.Tweening.Plugins.Options.RectOptions));
	}
}
