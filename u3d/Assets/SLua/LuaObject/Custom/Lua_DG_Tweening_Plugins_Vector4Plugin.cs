...
public class Lua_DG_Tweening_Plugins_Vector4Plugin : LuaObject {
	...
	static public int ConvertToStartValue(IntPtr l) {
		try{
			...
			checkType(l,3,out a2);
			UnityEngine.Vector4 ret=self.ConvertToStartValue(a1,a2);
			pushValue(l,ret);
			return 1;
		}
		catch(Exception e) {
